...
public class SelectionInitialeController{
   ...
   /*******************************/
    ...
    @FXML
    private Label labelChoisirProjet , labelSpecificationMesure ; 
...
/**************************************** Description Code ******************************************************/
                ...
                if (response.statusCode() == 200) {
                    ...
                    Platform.runLater(() -> {
                        ...
                        for (Map.Entry<String, String> entry : codesDescriptions.entrySet()) {
                            ...
                            String translationKey = "torsa." + code;
    ...
    private void traduireLabels() {
        try {
            ...
            labelSpecificationMesure.setText(bundle.getString("label.specification_mesure1"));
            btnSuivant.setText(bundle.getString("boutonSuivant"));
            description1.setText(bundle.getString("torsa.A"));
            description2.setText(bundle.getString("torsa.D"));
            description3.setText(bundle.getString("torsa.R"));
